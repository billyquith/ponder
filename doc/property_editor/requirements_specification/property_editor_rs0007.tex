...
enters in edit mode if the user double clicks it. Then, an editor is shown allowing the user to
change the cell value. When the user validates the changes, the cell returns to the view state.
